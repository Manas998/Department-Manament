...
public class studentNotes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        stdRollNO.setText("******");
        jPanel3.add(stdRollNO, new org.netbeans.lib.awtextra.AbsoluteConstraints(93, 100, -1, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Subject ", "Subject 1", "Subject 2", " " }));
        jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 80, 90, 40));

        jPanel4.setBackground(new java.awt.Color(153, 153, 153));
        jPanel4.setLayout(new java.awt.CardLayout());
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 940, 400));
 ...
 exit.setForeground(red);        // TODO add your handling code here:
    ...
    private void exitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exitMouseClicked
      ...
      studentform2.studentname.setText(studentNotes.stdname.getText());
      studentform2.stdno.setText(studentNotes.stdRollNO.getText());
 ...
 studentCLassRoom std = new  studentCLassRoom();
       ...
       studentCLassRoom.stdname.setText(studentNotes.stdname.getText());
       studentCLassRoom.stdRollNO.setText(studentNotes.stdRollNO.getText());
...
studentTimeTAble std = new  studentTimeTAble();
       ...
       studentTimeTAble.stdname.setText(studentNotes.stdname.getText());
      studentTimeTAble.stdRollNO.setText(studentNotes.stdRollNO.getText());
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
      studentAttendance std = new  studentAttendance();
       ...
       studentAttendance.stdname.setText(studentNotes.stdname.getText());
     studentAttendance.wwww.setText(studentNotes.stdRollNO.getText());
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
     studentAssignments std = new  studentAssignments();
       ...
       studentAssignments.stdname.setText(studentNotes.stdname.getText());
      studentAssignments.stdRollNO.setText(studentNotes.stdRollNO.getText());
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
     studentResult std = new  studentResult();
       ...
       studentResult.stdname.setText(studentNotes.stdname.getText());
      studentResult.stdRollNO.setText(studentNotes.stdRollNO.getText());
